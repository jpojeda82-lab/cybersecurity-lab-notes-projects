...
![Security Onion status showing all services healthy](screenshots/so-status-healthy.png)
...
![Nmap scan launched against the Metasploitable2 target](screenshots/nmap-scan.png)
...
![Alerts overview in the Security Onion web UI](screenshots/alerts-overview.png)

![Detail view of one of the Nmap detection alerts](screenshots/alert-detail.png)

![Hunt results showing the scan traffic](screenshots/hunt-results.png)
